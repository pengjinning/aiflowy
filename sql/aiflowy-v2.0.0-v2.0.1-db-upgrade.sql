...
INSERT INTO `tb_ai_llm`(`id`, `dept_id`, `tenant_id`, `title`, `brand`, `icon`, `description`, `llm_endpoint`, `llm_model`, `llm_api_key`, `llm_extra_config`, `options`, `group_name`, `model_type`, `provider`, `support_reasoning`, `support_tool`, `support_embedding`, `support_rerank`, `provider_id`, `added`, `can_delete`, `support_free`) VALUES (358577213303652352, 1, 1000000, 'test', NULL, NULL, NULL, NULL, 'ttt', NULL, NULL, '{\"rerankPath\":\"\",\"chatPath\":\"/api/v3/chat/completions\",\"llmEndpoint\":\"https://ark.cn-beijing.volces.com\",\"embedPath\":\"/api/v3/embeddings\"}', 'tttt', 'chatModel', 'volcengine', NULL, NULL, NULL, NULL, 358526394789171200, 0, NULL, NULL);
INSERT INTO `tb_ai_llm`(`id`, `dept_id`, `tenant_id`, `title`, `brand`, `icon`, `description`, `llm_endpoint`, `llm_model`, `llm_api_key`, `llm_extra_config`, `options`, `group_name`, `model_type`, `provider`, `support_reasoning`, `support_tool`, `support_embedding`, `support_rerank`, `provider_id`, `added`, `can_delete`, `support_free`) VALUES (359081705581277184, 1, 1000000, 'text-embedding-v3', NULL, NULL, NULL, NULL, 'text-embedding-v3', NULL, NULL, '{\"rerankPath\":\"/api/v1/services/rerank/text-rerank/text-rerank\",\"chatPath\":\"/compatible-mode/v1/chat/completions\",\"llmEndpoint\":\"https://dashscope.aliyuncs.com\",\"embedPath\":\"/compatible-mode/v1/embeddings\"}', 'text-embedding', 'embeddingModel', 'aliyun', 0, 0, 1, 0, 358526394789171200, 0, NULL, 0);
INSERT INTO `tb_ai_llm`(`id`, `dept_id`, `tenant_id`, `title`, `brand`, `icon`, `description`, `llm_endpoint`, `llm_model`, `llm_api_key`, `llm_extra_config`, `options`, `group_name`, `model_type`, `provider`, `support_reasoning`, `support_tool`, `support_embedding`, `support_rerank`, `provider_id`, `added`, `can_delete`, `support_free`) VALUES (359126106349228032, 1, 1000000, '111', NULL, NULL, NULL, NULL, '222', NULL, NULL, '{\"rerankPath\":\"\",\"chatPath\":\"\",\"llmEndpoint\":\"\",\"embedPath\":\"\"}', '33', 'chatModel', '', 0, 0, 0, 0, 359111228158771200, 0, NULL, 0);
INSERT INTO `tb_ai_llm`(`id`, `dept_id`, `tenant_id`, `title`, `brand`, `icon`, `description`, `llm_endpoint`, `llm_model`, `llm_api_key`, `llm_extra_config`, `options`, `group_name`, `model_type`, `provider`, `support_reasoning`, `support_tool`, `support_embedding`, `support_rerank`, `provider_id`, `added`, `can_delete`, `support_free`) VALUES (359127472849276928, 1, 1000000, '443', NULL, NULL, NULL, NULL, '444', NULL, NULL, '{\"rerankPath\":\"\",\"chatPath\":\"\",\"llmEndpoint\":\"\",\"embedPath\":\"\"}', '444', 'chatModel', '', 0, 0, 0, 0, 359111228158771200, 0, NULL, 0);
